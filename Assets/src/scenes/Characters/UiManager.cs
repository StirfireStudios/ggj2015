...
namespace GGJ.Scenes.Characters {
	...
	public class UiManager : MonoBehaviour {
		...
		public void AnimateStatic() {
			for (var i = 0; i < Character.All.Count; ++i) {
				Character.All[i].state = CharacterState.Static;
			}
		}
		...
		public void AnimateMove() {
			for (var i = 0; i < Character.All.Count; ++i) {
				Character.All[i].state = CharacterState.Move;
			}
		}
		...
		public void AnimateAttack() {
			for (var i = 0; i < Character.All.Count; ++i) {
				Character.All[i].state = CharacterState.Attack;
			}
		}
		...
		public void AnimateJump() {
			for (var i = 0; i < Character.All.Count; ++i) {
				Character.All[i].state = CharacterState.Jump;
			}
		}
		...
		public void AnimateDead() {
			for (var i = 0; i < Character.All.Count; ++i) {
				Character.All[i].state = CharacterState.Dead;
			}
		}
	}
}
